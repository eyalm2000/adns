...
object NextDnsSettingRegistry {
    val security = SettingsPageSpec(
        ...
        settings = listOf(
            ...
            booleanSetting("security", "untrustedCertificates", "security", "untrustedCertificates", FeatureMaturity.EARLY_ACCESS),
            ...
            booleanSetting("security", "dnsPayloadDelivery", "security", "dnsPayloadDelivery", FeatureMaturity.EARLY_ACCESS),
            ...
            booleanSetting("security", "highRiskTlds", "security", "highRiskTlds", FeatureMaturity.EARLY_ACCESS),
